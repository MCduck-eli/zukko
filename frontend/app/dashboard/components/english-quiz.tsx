...
export default function EnglishQuiz({ onClose }: EnglishQuizProps) {
        ...
        const fetchQuestions = async () => {
            ...
            try {
                ...
                const res = await fetch(
                    `${baseUrl}/questions?category=english&limit=10`,
                );
    ...
    if (!questions || questions.length === 0)
        return (
            <div className="text-white text-center py-10">
                English faniga oid savollar topilmadi.
            </div>
        );
