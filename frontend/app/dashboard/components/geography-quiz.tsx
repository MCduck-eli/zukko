...
export default function GeographyQuiz({ onClose }: GeographyQuizProps) {
        ...
        const fetchQuestions = async () => {
            ...
            try {
                ...
                const res = await fetch(
                    `${baseUrl}/questions?category=geography&limit=10`,
                );
    ...
    if (isLoading)
        return (
            <div className="text-white text-center py-10 animate-pulse font-medium">
                Geografiya savollari yuklanmoqda...
            </div>
        );
    ...
    if (!questions || questions.length === 0)
        return (
            <div className="text-white text-center py-10">
                Geografiya faniga oid savollar topilmadi.
            </div>
        );
