...
export default function BiologyQuiz({ onClose }: BiologyQuizProps) {
        ...
        const fetchQuestions = async () => {
            ...
            try {
                ...
                const res = await fetch(
                    `${baseUrl}/questions?category=biology&limit=10`,
                );
    ...
    if (isLoading)
        return (
            <div className="text-white text-center py-10 animate-pulse font-medium">
                Biologiya savollari yuklanmoqda...
            </div>
        );
    ...
    if (!questions || questions.length === 0)
        return (
            <div className="text-white text-center py-10">
                Biologiya faniga oid savollar topilmadi.
            </div>
        );
