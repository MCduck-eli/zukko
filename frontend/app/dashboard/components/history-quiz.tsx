...
export default function HistoryQuiz({ onClose }: HistoryQuizProps) {
        ...
        const fetchQuestions = async () => {
            ...
            try {
                ...
                const res = await fetch(
                    `${baseUrl}/questions?category=history&limit=10`,
                );
    ...
    if (!questions || questions.length === 0)
        return (
            <div className="text-white text-center py-10">
                Tarix faniga oid savollar topilmadi.
            </div>
        );
